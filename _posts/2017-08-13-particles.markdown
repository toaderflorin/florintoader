---
layout: post
title:  "So What The Heck Is Going On?"
...
OK, enough with the oil stuff, but we can already answer the question - **no**, the particle doesn't need to be in two places at the same time, it's being guided by the wave.
...
Let's first look at a couple of things. We know each particle has a coresponding antiparticle - the antiparticle of the electron is the positron. Obviously, it goes both ways - the electron is the antiparticle of the electron (by the way, the antiparticle of the up quark is not the down quark, because the up quark has +2/3 electric charge, and the down quark has -1/3 electric charge. It's the anti-up quark). Because the photon doesn't have electric charge, the antiparticle of a photon is still a high energy gamma ray (photon).

We know that when a particle colides with it's antiparticle, both of them annihilate and they produce energy in the form of a photon. But since our universe has a law called **T-symmetry** or *time reversal symmetry*, this gamma ray can also spontaneously split into a electron-positron pair, as seen in this picture.

![image-title-here](/images/diagram.jpg){:class="img-responsive"} 

We know that empty space is not really empty because that would violate Heisenberg's Uncertainty Principle, so there is a minimal amount of jitter when you get close to Plank scale. 

Empty space looks something like this actually:
...
But here's the deal: our universe is not empty, *it has a slight assymetry of matter over antimatter*. So let's add an electron to our field, and impart it some momentum. Instead of a bazzilion electrons and a bazzilion positrons, we are going to have a bazzilion + 1 one electron and a bazzilion positrons. 

Here's what's going to happen: our electron is going to bump into a positron, and it's going to annihilate, leaving an unpaired electron which is going to fly off in some direction. This new electron will fly of in some other direction and bump into anoter positron etc. 

What you get is something like this:

![image-title-here](/images/newton.jpg){:class="img-responsive"} 

which is mathematically equivalent to this from the previous article:
