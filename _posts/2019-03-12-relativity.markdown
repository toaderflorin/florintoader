...
As strange as these things sound, nobody walks around and thinks: <i>hmm, I think that if I move at a certain speed relative to the Earth, time would have to pass slower for me</i>. Yet Einstein's theory of relativity says this absolutely must happen, it gives us the *exact rate* at which it happens and we can also build very precise atomic clocks that can measure differences in the passage of time and they are in perfect agreement with predictions.
...
So if electromagnetism is a wave, then the natural intuition would be to ask: *a wave propagating through what medium?* And sure enough, people did set out to find traces it (a medium which they dubbed a [luminiferous aether](https://en.wikipedia.org/wiki/Luminiferous_aether)), with the most famous of the attempts being the Michelson-Morley experiment. It was known at the time the Earth is moving at a relative speed of approximately 100 000 km/h around the Sun and that the Sun should also be in motion, so the intention was to figure out the overall relative speed of the Earth to the aether. What Michelson and Morley did was they tried to measure the difference in speed between light coming  directly from the Sun and light moving in a perpendicular direction to this (which would coincide with the direction of movement of the Earth). They did it using an interferometer which would be able to pick up the smallest difference in speed. 

![em-wave](/images/ether.jpg){:class="img-responsive"}

*To their dismay. they didn't find any*. The result of this experiment was considered very weird because the notion that the Earth was stationary was long ago abandoned. So in order to save the idea, various tweaks to the aether theory had to be introduced and one such idea was the *aether drag*, which speculated that as objects move they drag this aether along with them. Another idea, coming from Hendrick Lorentz, was that since electromagnetism mediates interactions between molecules, the arm parallel to the direction of motion shortens in length in such a way that no difference in speed is detectable. 

The compression factor would have to be ![factor](/images/factor.svg). He also came up with the concept of [local time](https://en.wikipedia.org/wiki/Lorentz_ether_theory#Local_time) which implied a dilation relationship (to which he imputed no physical meaning, he simply regarded it as a calculation tool). [[BAD]]
...
Let's exemplify with another thought experiment using the following setup: assuming we have a wire through which an electric current flows (again with speed __*v*__) and an electrically charged object placed next to the wire, we can again think about the forces that appear on the object in the two reference frames: 
  ...
  1. In the wire's frame of reference, the electrons move at speed __*v*__, so their frame contracts which changes the net charge density of the wire which makes it have a negative overall charge and this in turn acts on the charged object. 
...
So Einstein's major insight was that the phenomena we see are a byproduct of one's frame of observation (hence the name *relativity*): *what looks like an electric field to me is a magnetic field to aunt Marge, if she's moving at a speed that's high enough relative to me.* But there's something else that's even more interesting: if you take the Lorentz transforms and you apply them to something that moves at the speed of light (essentially any elementary particle in the absence of a Higgs field), they tell you that space contracts to zero and time dilates to infinity and pretty much stops flowing. 
