...
---
When I was trying to learn guitar the first thing that I learned was the scales, because I wanted to be like Hendrix. Getting past the fact that rythm is the foundation of music, not harmony, there was one thing that really struck me as odd: was how strange it looked when played on a a single guitar string (going higher or lower on the neck to play different notes). I mean, you can fret anywhere so why is the distance between all notes 2 frets, except between B and C and also E and F?
